...
This first preview includes the Package Conflict skirmish, original artwork for both factions, and a single installer for your x86_64 Omarchy / Arch PC.
...
curl -fLO https://github.com/tcballard/command-and-conquer-omarchy/releases/download/v0.0.1-preview.1/install-omarchy-edition.sh
curl -fLO https://github.com/tcballard/command-and-conquer-omarchy/releases/download/v0.0.1-preview.1/install-omarchy-edition.sh.sha256
...
Let OpenRA install its Red Alert content if prompted. Then choose **Singleplayer → Skirmish → Omarchy Skirmish - Package Conflict**. Take the green slot and add Normal AI in the pink Walled Garden slot. Steam and Yuri's Revenge are not required.
