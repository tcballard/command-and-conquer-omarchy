...
Download **[install-omarchy-edition.sh](https://github.com/tcballard/command-and-conquer-omarchy/releases/download/v0.0.1-preview.6/install-omarchy-edition.sh)** from the preview release,
...
**preview 6 (bundled)**. There is no map-change button, campaign browser,
